...
export default function DashboardAdmin({ activeTab, setActiveTab }: DashboardAdminProps) {
  ...
  return (
    <div>
      ...
      {!['dashboard', 'profissionais', 'clientes', 'usuarios', 'controle_creditos', 'planos', 'agenda_fixa', 'testes_forca', 'financeiro', 'medicamentos', 'tv_panel', 'solicitacoes_exercicios', 'configuracoes', 'log_atividades'].includes(activeTab) && (
