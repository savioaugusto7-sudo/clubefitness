...
export function downloadContractPDF(client: any, plan: any, templateOverride?: any, contract?: any) {
  ...
  if (!templateOverride) {
    templateOverride = getUnifiedTemplate({
      ...
      dataVencimento: com.dataPrimeiroVencimento || com.vencimento,
      dataPrimeiroVencimento: com.dataPrimeiroVencimento || com.vencimento,
      diaVencimento: com.diaVencimento || (com.dataPrimeiroVencimento ? parseInt(com.dataPrimeiroVencimento.split('-')[2], 10) : diaVenc),
