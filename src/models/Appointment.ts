...
const AppointmentSchema = new Schema({
  ...
  tipo: { type: String, enum: ['academia', 'dr_albert', 'dr_guilherme'], required: true },
  ...
  profissionalId: { type: Schema.Types.ObjectId, ref: 'Professional', required: false, default: null },
