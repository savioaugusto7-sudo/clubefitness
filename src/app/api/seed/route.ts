...
export async function GET() {
  ...
  try {
    ...
    // 2. Insert Plans
    const plansData = [
      { _id: ids.plans.plan_1, nome: 'Academia VIP', validadeDias: 30, limiteSessoesAcademia: 20, limiteSessoesConsultorio: 0, preco: 0, creditosTotal: 20, servicosPermitidos: ['Treino Monitorado', 'Treino Livre', 'Recovery', 'Avaliação Física', 'Teste de Força', 'Massagem'] },
      { _id: ids.plans.plan_2, nome: 'Fisioterapia Individual', validadeDias: 30, limiteSessoesAcademia: 0, limiteSessoesConsultorio: 8, preco: 0, creditosTotal: 8, servicosPermitidos: ['Avaliação Fisioterápica', 'Emergência', 'Massagem'] },
      { _id: ids.plans.plan_3, nome: 'Clube Completo (Fisio + Academia)', validadeDias: 30, limiteSessoesAcademia: 12, limiteSessoesConsultorio: 4, preco: 0, creditosTotal: 16, servicosPermitidos: ['Treino Monitorado', 'Treino Livre', 'Recovery', 'Avaliação Física', 'Teste de Força', 'Avaliação Fisioterápica', 'Emergência', 'Massagem'] },
      { _id: ids.plans.plan_emergencial, nome: 'Plano Emergencial', validadeDias: 14, limiteSessoesAcademia: 0, limiteSessoesConsultorio: 14, preco: 0, creditosTotal: 14, servicosPermitidos: ['Avaliação Fisioterápica', 'Emergência', 'Massagem'] },
      { _id: ids.plans.plan_emergencial_2, nome: 'Plano Emergencial 2', validadeDias: 28, limiteSessoesAcademia: 0, limiteSessoesConsultorio: 28, preco: 0, creditosTotal: 28, servicosPermitidos: ['Avaliação Fisioterápica', 'Emergência', 'Massagem'] },
      { _id: ids.plans.plan_agudo, nome: 'Agudo', validadeDias: 30, limiteSessoesAcademia: 30, limiteSessoesConsultorio: 8, preco: 0, creditosTotal: 38, servicosPermitidos: ['Treino Monitorado', 'Treino Livre', 'Recovery', 'Avaliação Física', 'Teste de Força', 'Avaliação Fisioterápica', 'Emergência', 'Massagem'] },
      { _id: ids.plans.plan_cronico_1, nome: 'Crônico 1', validadeDias: 30, limiteSessoesAcademia: 30, limiteSessoesConsultorio: 12, preco: 0, creditosTotal: 42, servicosPermitidos: ['Treino Monitorado', 'Treino Livre', 'Recovery', 'Avaliação Física', 'Teste de Força', 'Avaliação Fisioterápica', 'Emergência', 'Massagem'] },
      { _id: ids.plans.plan_cronico_2, nome: 'Crônico 2', validadeDias: 365, limiteSessoesAcademia: 365, limiteSessoesConsultorio: 52, preco: 0, creditosTotal: 417, servicosPermitidos: ['Treino Monitorado', 'Treino Livre', 'Recovery', 'Avaliação Física', 'Teste de Força', 'Avaliação Fisioterápica', 'Emergência', 'Massagem'] },
      { _id: ids.plans.plan_academia, nome: 'Academia', validadeDias: 30, limiteSessoesAcademia: 9, limiteSessoesConsultorio: 0, preco: 0, creditosTotal: 9, servicosPermitidos: ['Treino Monitorado', 'Treino Livre', 'Recovery', 'Avaliação Física', 'Teste de Força', 'Avaliação Fisioterápica', 'Emergência', 'Massagem'] }
    ];
