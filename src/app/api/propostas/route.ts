...
export async function PUT(request: Request) {
  try {
    ...
    client.dadosPessoais = {
      ...
      nacionalidade: dadosPreenchidos.nacionalidade || pes.nacionalidade,
      estadoCivil: dadosPreenchidos.estadoCivil || pes.estadoCivil,
      profissao: dadosPreenchidos.profissao || pes.profissao,
