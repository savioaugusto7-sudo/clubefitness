...
async function run() {
  ...
  console.log(`👤 Cliente: ${client.dadosPessoais?.nome}`);
  console.log(`💼 Status Comercial: ${client.dadosComerciais?.status}`);
  console.log(`📊 Dados Comerciais completos:`, JSON.stringify(client.dadosComerciais, null, 2));
